...
const tableBaseClass =
    'mx-auto w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden '

const tableHeadClass = 'bg-gray-50'

const tableHeadTrClass = 'bg-gray-200 text-gray-600 uppercase text-sm leading-normal'
...
const tableBodyTdClass = 'px-6 py-4 text-black '
